...
class Recognizer(AudioSource):
    ...
    def recognize_google_cloud(self, audio_data, credentials_json=None, language="en-US", preferred_phrases=None, show_all=False):
        ...
        try:
            ...
            #print('from google.cloud.speech import enums')
            #from google.cloud.speech import types
            from google.cloud.speech_v1 import types
            #print('from google.cloud.speech import types')
            from google.api_core.exceptions import GoogleAPICallError
            #print('from google.api_core.exceptions import GoogleAPICallError')
        except ImportError:
        ...
        #}
        config = {
            'encoding': types.cloud_speech.RecognitionConfig.AudioEncoding.FLAC,
            'sample_rate_hertz': audio_data.sample_rate,
            'language_code': language
        }
        ...
        config = types.cloud_speech.RecognitionConfig(**config)
